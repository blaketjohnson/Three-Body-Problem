...
2.1 Determine new constants and know values
2.2 Determine equations to use for the gradient of the potential
2.3 Determine the potential energy, the gradient, and the equations of motion
2.4 plot the RTBP
...
# NOTE: I tried to do these in terms of mu1 and mu2. When that did not work I tried just mu. Finally I wrote it in terms of just u. So, u = mu
